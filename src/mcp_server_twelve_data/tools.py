...
def register_all_tools(server: FastMCP, _call_endpoint):
    ...
    async def GetCurrencyConversion(params: GetCurrencyConversionRequest,
                                    ctx: Context) -> GetCurrencyConversion200Response:
    ...
    async def GetEarliestTimestamp(params: GetEarliestTimestampRequest,
                                   ctx: Context) -> GetEarliestTimestamp200Response:
    ...
    async def GetCryptocurrencyExchanges(params: GetCryptocurrencyExchangesRequest,
                                         ctx: Context) -> GetCryptocurrencyExchanges200Response:
    ...
    @server.tool(name="GetCrossListings",
                 description="This API call returns an array of cross listed symbols for a specified instrument. Cross listings are the same securities listed on different exchanges.")
    ...
    async def GetTechnicalIndicators(params: GetTechnicalIndicatorsRequest,
                                     ctx: Context) -> GetTechnicalIndicators200Response:
    ...
    @server.tool(name="GetIncomeStatement",
                 description="Returns complete income statement of a company and shows the companys revenues and expenses during a period (annual or quarter).")
    ...
    async def GetTimeSeriesSuperTrend(params: GetTimeSeriesSuperTrendRequest,
                                      ctx: Context) -> GetTimeSeriesSuperTrend200Response:
        return await _call_endpoint("supertrend", params, GetTimeSeriesSuperTrend200Response, ctx)

    @server.tool(name="GetEarningsCalendar",
                 description="This API method returns earning data as a calendar for a given date range. By default todays earning is returned. To call custom period, use start_date and end_date parameters.")
    ...
    async def GetDividendsCalendar(params: GetDividendsCalendarRequest,
                                   ctx: Context) -> GetDividendsCalendar200Response:
    ...
    async def GetTimeSeriesHeikinashiCandles(params: GetTimeSeriesHeikinashiCandlesRequest,
                                             ctx: Context) -> GetTimeSeriesHeikinashiCandles200Response:
    ...
    async def GetAnalystRatingsUsEquities(params: GetAnalystRatingsUsEquitiesRequest,
                                          ctx: Context) -> GetAnalystRatingsUsEquities200Response:
    ...
    async def GetTimeSeriesIchimoku(params: GetTimeSeriesIchimokuRequest,
                                    ctx: Context) -> GetTimeSeriesIchimoku200Response:
    ...
    async def GetTimeSeriesPercent_B(params: GetTimeSeriesPercent_BRequest,
                                     ctx: Context) -> GetTimeSeriesPercent_B200Response:
    ...
    async def GetAnalystRatingsLight(params: GetAnalystRatingsLightRequest,
                                     ctx: Context) -> GetAnalystRatingsLight200Response:
    ...
    async def GetInsiderTransactions(params: GetInsiderTransactionsRequest,
                                     ctx: Context) -> GetInsiderTransactions200Response:
    ...
    @server.tool(name="GetInstitutionalHolders",
                 description="Returns the amount of the companys available stock owned by institutions (pension funds, insurance companies, investment firms, private foundations, endowments, or other large entities that manage funds on behalf of others).")
    async def GetInstitutionalHolders(params: GetInstitutionalHoldersRequest,
                                      ctx: Context) -> GetInstitutionalHolders200Response:
    ...
    async def GetTimeSeriesMinusDI(params: GetTimeSeriesMinusDIRequest,
                                   ctx: Context) -> GetTimeSeriesMinusDI200Response:
    ...
    async def GetTimeSeriesStochRsi(params: GetTimeSeriesStochRsiRequest,
                                    ctx: Context) -> GetTimeSeriesStochRsi200Response:
    ...
    async def GetIncomeStatementConsolidated(params: GetIncomeStatementConsolidatedRequest,
                                             ctx: Context) -> GetIncomeStatementConsolidated200Response:
    ...
    async def GetTimeSeriesPivotPointsHL(params: GetTimeSeriesPivotPointsHLRequest,
                                         ctx: Context) -> GetTimeSeriesPivotPointsHL200Response:
    ...
    @server.tool(name="GetFundHolders",
                 description="Returns the amount of the companys available stock owned by mutual fund holders.")
    ...
    async def GetTimeSeriesAvgPrice(params: GetTimeSeriesAvgPriceRequest,
                                    ctx: Context) -> GetTimeSeriesAvgPrice200Response:
    ...
    async def GetMutualFundsWorldPerformance(params: GetMutualFundsWorldPerformanceRequest,
                                             ctx: Context) -> GetMutualFundsWorldPerformance200Response:
    ...
    async def GetBalanceSheetConsolidated(params: GetBalanceSheetConsolidatedRequest,
                                          ctx: Context) -> GetBalanceSheetConsolidated200Response:
    ...
    async def GetMutualFundsWorldRatings(params: GetMutualFundsWorldRatingsRequest,
                                         ctx: Context) -> GetMutualFundsWorldRatings200Response:
    ...
    async def GetMutualFundsWorldSummary(params: GetMutualFundsWorldSummaryRequest,
                                         ctx: Context) -> GetMutualFundsWorldSummary200Response:
    ...
    async def GetTimeSeriesLinearReg(params: GetTimeSeriesLinearRegRequest,
                                     ctx: Context) -> GetTimeSeriesLinearReg200Response:
    ...
    async def GetTimeSeriesKeltner(params: GetTimeSeriesKeltnerRequest,
                                   ctx: Context) -> GetTimeSeriesKeltner200Response:
    ...
    async def GetMutualFundsWorldComposition(params: GetMutualFundsWorldCompositionRequest,
                                             ctx: Context) -> GetMutualFundsWorldComposition200Response:
    ...
    async def GetMutualFundsWorldPurchaseInfo(params: GetMutualFundsWorldPurchaseInfoRequest,
                                              ctx: Context) -> GetMutualFundsWorldPurchaseInfo200Response:
        return await _call_endpoint("mutual_funds/world/purchase_info", params,
                                    GetMutualFundsWorldPurchaseInfo200Response, ctx)
    ...
    async def GetETFsWorldPerformance(params: GetETFsWorldPerformanceRequest,
                                      ctx: Context) -> GetETFsWorldPerformance200Response:
    ...
    async def GetEdgarFilingsArchive(params: GetEdgarFilingsArchiveRequest,
                                     ctx: Context) -> GetEdgarFilingsArchive200Response:
    ...
    async def GetTimeSeriesHtTrendMode(params: GetTimeSeriesHtTrendModeRequest,
                                       ctx: Context) -> GetTimeSeriesHtTrendMode200Response:
    ...
    async def GetTimeSeriesMidPrice(params: GetTimeSeriesMidPriceRequest,
                                    ctx: Context) -> GetTimeSeriesMidPrice200Response:
    ...
    async def GetMutualFundsWorldSustainability(params: GetMutualFundsWorldSustainabilityRequest,
                                                ctx: Context) -> GetMutualFundsWorldSustainability200Response:
        return await _call_endpoint("mutual_funds/world/sustainability", params,
                                    GetMutualFundsWorldSustainability200Response, ctx)
    ...
    async def GetETFsWorldComposition(params: GetETFsWorldCompositionRequest,
                                      ctx: Context) -> GetETFsWorldComposition200Response:
    ...
    async def GetMutualFundsWorldRisk(params: GetMutualFundsWorldRiskRequest,
                                      ctx: Context) -> GetMutualFundsWorldRisk200Response:
    ...
    async def GetMutualFundsFamily(params: GetMutualFundsFamilyRequest,
                                   ctx: Context) -> GetMutualFundsFamily200Response:
    ...
    async def GetCashFlowConsolidated(params: GetCashFlowConsolidatedRequest,
                                      ctx: Context) -> GetCashFlowConsolidated200Response:
    ...
    async def GetTimeSeriesWclPrice(params: GetTimeSeriesWclPriceRequest,
                                    ctx: Context) -> GetTimeSeriesWclPrice200Response:
    ...
    async def GetTimeSeriesHtDcPeriod(params: GetTimeSeriesHtDcPeriodRequest,
                                      ctx: Context) -> GetTimeSeriesHtDcPeriod200Response:
    ...
    async def GetTimeSeriesMedPrice(params: GetTimeSeriesMedPriceRequest,
                                    ctx: Context) -> GetTimeSeriesMedPrice200Response:
    ...
    async def GetTimeSeriesTypPrice(params: GetTimeSeriesTypPriceRequest,
                                    ctx: Context) -> GetTimeSeriesTypPrice200Response:
    ...
    async def GetTimeSeriesHtTrendline(params: GetTimeSeriesHtTrendlineRequest,
                                       ctx: Context) -> GetTimeSeriesHtTrendline200Response:
    ...
    async def GetTimeSeriesLinearRegAngle(params: GetTimeSeriesLinearRegAngleRequest,
                                          ctx: Context) -> GetTimeSeriesLinearRegAngle200Response:
    ...
    async def GetTimeSeriesMinusDM(params: GetTimeSeriesMinusDMRequest,
                                   ctx: Context) -> GetTimeSeriesMinusDM200Response:
    ...
    async def GetTimeSeriesHtDcPhase(params: GetTimeSeriesHtDcPhaseRequest,
                                     ctx: Context) -> GetTimeSeriesHtDcPhase200Response:
    ...
    async def GetTimeSeriesMidPoint(params: GetTimeSeriesMidPointRequest,
                                    ctx: Context) -> GetTimeSeriesMidPoint200Response:
    ...
    async def GetTimeSeriesHtPhasor(params: GetTimeSeriesHtPhasorRequest,
                                    ctx: Context) -> GetTimeSeriesHtPhasor200Response:
    ...
    async def GetTimeSeriesMacdExt(params: GetTimeSeriesMacdExtRequest,
                                   ctx: Context) -> GetTimeSeriesMacdExt200Response:
    ...
    @server.tool(name="GetTimeSeriesAcos",
                 description="The Arccosine (ACOS) indicator calculates the inverse cosine of a given input value, typically used in trigonometric and harmonic pattern analysis within financial markets.")
    ...
    async def GetTimeSeriesAroonOsc(params: GetTimeSeriesAroonOscRequest,
                                    ctx: Context) -> GetTimeSeriesAroonOsc200Response:
        return await _call_endpoint("aroonosc", params, GetTimeSeriesAroonOsc200Response, ctx)

    @server.tool(name="GetTimeSeriesAsin",
                 description="The Arcsine (ASIN) indicator calculates the inverse sine of a given input value, primarily used in trigonometric and harmonic pattern analysis in financial markets.")
    ...
    @server.tool(name="GetTimeSeriesAtan",
                 description="The Arctangent (ATAN) indicator calculates the inverse tangent of a given input value, mainly used in trigonometric and harmonic pattern analysis in financial markets.")
    ...
    async def GetTimeSeriesCoppock(params: GetTimeSeriesCoppockRequest,
                                   ctx: Context) -> GetTimeSeriesCoppock200Response:
        return await _call_endpoint("coppock", params, GetTimeSeriesCoppock200Response, ctx)

    @server.tool(name="GetTimeSeriesCos",
                 description="The Cosine (COS) indicator calculates the cosine of a given input value, primarily used in trigonometric and harmonic pattern analysis within financial markets.")
    ...
    @server.tool(name="GetTimeSeriesCosh",
                 description="The Hyperbolic Cosine (COSH) indicator calculates the hyperbolic cosine of a given input value, often used in advanced mathematical analysis or calculations in financial markets.")
    ...
    async def GetTimeSeriesLinearRegIntercept(params: GetTimeSeriesLinearRegInterceptRequest,
                                              ctx: Context) -> GetTimeSeriesLinearRegIntercept200Response:
    ...
    async def GetTimeSeriesLinearRegSlope(params: GetTimeSeriesLinearRegSlopeRequest,
                                          ctx: Context) -> GetTimeSeriesLinearRegSlope200Response:
    ...
    async def GetTimeSeriesMacdSlope(params: GetTimeSeriesMacdSlopeRequest,
                                     ctx: Context) -> GetTimeSeriesMacdSlope200Response:
    ...
    async def GetTimeSeriesMaxIndex(params: GetTimeSeriesMaxIndexRequest,
                                    ctx: Context) -> GetTimeSeriesMaxIndex200Response:
    ...
    async def GetTimeSeriesMcGinleyDynamic(params: GetTimeSeriesMcGinleyDynamicRequest,
                                           ctx: Context) -> GetTimeSeriesMcGinleyDynamic200Response:
    ...
    async def GetTimeSeriesMinIndex(params: GetTimeSeriesMinIndexRequest,
                                    ctx: Context) -> GetTimeSeriesMinIndex200Response:
    ...
    async def GetTimeSeriesMinMaxIndex(params: GetTimeSeriesMinMaxIndexRequest,
                                       ctx: Context) -> GetTimeSeriesMinMaxIndex200Response:
    ...
    async def GetTimeSeriesRocr100(params: GetTimeSeriesRocr100Request,
                                   ctx: Context) -> GetTimeSeriesRocr100200Response:
    ...
    async def GetSourceSanctionedEntities(params: GetSourceSanctionedEntitiesRequest,
                                          ctx: Context) -> GetSourceSanctionedEntities200Response:
    ...
    @server.tool(name="GetTimeSeriesSin",
                 description="The Sine (SIN) indicator calculates the sine of a given input value, primarily used in trigonometric and harmonic pattern analysis within financial markets.")
    ...
    @server.tool(name="GetTimeSeriesSinh",
                 description="The Hyperbolic Sine (SINH) indicator calculates the hyperbolic sine of a given input value, often used in advanced mathematical analysis or calculations in financial markets.")
    ...
    async def GetTimeSeriesSuperTrendHeikinAshiCandles(params: GetTimeSeriesSuperTrendHeikinAshiCandlesRequest,
                                                       ctx: Context) -> GetTimeSeriesSuperTrendHeikinAshiCandles200Response:
        return await _call_endpoint("supertrend_heikinashicandles", params,
                                    GetTimeSeriesSuperTrendHeikinAshiCandles200Response, ctx)
    ...
    @server.tool(name="GetTimeSeriesTan",
                 description="The Tangent (TAN) indicator calculates the tangent of a given input value, primarily used in trigonometric and harmonic pattern analysis within financial markets.")
    ...
    @server.tool(name="GetTimeSeriesTanh",
                 description="The Hyperbolic Tangent (TANH) indicator calculates the hyperbolic tangent of a given input value, often used in advanced mathematical analysis or calculations in financial markets.")
